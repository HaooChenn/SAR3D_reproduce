...
torchrun --nproc_per_node=7 --nnodes=1 --rdzv-endpoint=localhost:3000 --rdzv_backend=c10d train.py \
  ...
  --vqvae_pretrained_path='/nas/shared/public/yslan/cyw/ln3diff_VAR/log/seperate_GAN_LRM_256_large_lr/model_rec0400000.pt' \
  --local_out_dir_path /nas/shared/public/yslan/cyw/ln3diff_VAR/log/VAR_Image/local_output_depth_24_bf16_256 \
