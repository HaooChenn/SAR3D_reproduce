...
def rendering_options_defaults(opts):
    ...
    elif opts.cfg == 'objverse_tuneray_aug_resolution_256_256_auto':  # to differentiate hwc
        rendering_options.update({
            'depth_resolution':
            # 128,
             256,
    ...
    elif opts.cfg == 'objverse_tuneray_aug_resolution_32_32_auto':  # to differentiate hwc
        rendering_options.update({
            'depth_resolution':
            32,
            'depth_resolution_importance':
    ...
    elif opts.cfg == 'objverse_tuneray_aug_resolution_48_48_auto':  # to differentiate hwc
        rendering_options.update({
            'depth_resolution':
            48,
            'depth_resolution_importance':
    ...
    # True here
        ...
        if 'lgm' not in dino_version: # TODO, for compat now
            ...
            encoder = encoder_cls(
                ...
                out_ch=3,  # unused
                # z_channels=32 * 3, # 4 * 3
                z_channels= Cvae * 3, # codebook size
                # z_channels=16 *3,
                attn_kwargs=attn_kwargs,
            )  # stable diffusion encoder
