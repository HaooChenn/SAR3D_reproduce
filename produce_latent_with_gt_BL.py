...
def save_latent(ld_or_itrt, args: arg_util.Args, trainer, dataset_size):
    ...
    # candiadate_list = [
    # candiadate_list = ["/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_23874.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_24198.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_27218.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_48544.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_48879.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_50795.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_53230.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_55738.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_60225.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_74401.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_3649.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_4085.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_4442.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_7722.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_9266.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_9370.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_9564.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_10600.png",
    #                     "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/1_13734.png",
    # candiadate_list = ["/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/view_1.png"]
    folder_path = "/mnt/slurm_home/ywchen/projects/VAR-image/VAR/gt_BL"
    # candidate_list = ["/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/7/61494/gt_BL_dim_8_l2norm_lrm_256.npy",
    # candidate_list = ["/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/6/56944/gt_BL_dim_8_l2norm_lrm_256.npy",
    #                   "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/6/56945/gt_BL_dim_8_l2norm_lrm_256.npy",
    #                   "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/6/56946/gt_BL_dim_8_l2norm_lrm_256.npy"]
    candidate_list = ["/mnt/slurm_home/ywchen/projects/VAR-image/VAR/eval_teaser/slice_8/1732687657/G_BL.pt"]

    for iter, data in enumerate(tqdm(ld_or_itrt), start=0):
        ...
        # print(data['caption'])
        # st()
        # file_name = os.path.join("/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/","/".join(os.path.basename(candiadate_list[iter]).split(".")[0].split("_")), "gt_BL_dim_8_l2norm_lrm_256.npy")
        # latent_file_name = "/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/1/74721/gt_BL_dim_8_l2norm_lrm_256.npy"
        latent_file_name = candidate_list[iter]
        gt_BL = torch.load(latent_file_name).to(args.device)
        # st()
        # gt_BL = torch.from_numpy(np.load(latent_file_name)).to(args.device)
        if gt_BL.shape[0] != 1:
            gt_BL = gt_BL.unsqueeze(0)
        file_name = "it{}_".format(iter) + "_".join(latent_file_name.split('/')[-3:-1])
        # st()
        # data['sample_path'][0] = '/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/1/74121/'
        # file_name = "it{}_".format(iter) + "_".join(data['sample_path'][0].split('/')[-2:])
        # gt_BL = torch.from_numpy(np.load(os.path.join(data['sample_path'][0],"gt_BL_dim_8_l2norm_lrm_256.npy"))).to(args.device).unsqueeze(0)
        # gt_BL = data['gt_BL'].to(args.device)
        # st()
        # gt_BL = torch.from_numpy(np.load(candidate_list[iter])).to(args.device).unsqueeze(0)
        # gt_BL = torch.from_numpy(np.load(file_name)).to(args.device).unsqueeze(0)
        # # =================== generate latent ===================
        # st()
        ...
        with torch.no_grad():
            if iter < 500:
                ...
                # triplane_gt_BL= trainer.var_wo_ddp.reconstruct_gt_Bl_idx_multiscale(B=1, label_B=label_B, cfg=cfg, top_k=900, top_p=0.95, g_seed=0, more_smooth=more_smooth, gt_idx=gt_BL)
                ...
                #         render_video_given_triplane(triplane_i, trainer.vae_local, name_prefix=f'{os.path.basename(candiadate_list[iter]).split(".")[0]}', render_reference={'c': camera}, save_img=True, save_mesh=True, save_path=os.path.join("/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/",os.path.basename(candiadate_list[iter]).split(".")[0]))
                #         shutil.copy(candiadate_list[iter], os.path.join("/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/",os.path.basename(candiadate_list[iter]).split(".")[0]))
                #     else:
                #         render_video_given_triplane_mesh(triplane_i, trainer.vae_local, name_prefix=f'{os.path.basename(candiadate_list[iter]).split(".")[0]}', render_reference={'c': camera}, save_img=False, save_mesh=True, save_path=args.save_path)
                for k in range(1, 11):
                    if k==1:
                        continue
                    triplane_gt_BL= trainer.var_wo_ddp.reconstruct_gt_Bl_idx_multiscale(B=1, label_B=label_B, cfg=cfg, top_k=900, top_p=0.95, g_seed=0, more_smooth=more_smooth, gt_idx=gt_BL, scale=k)
                    camera = torch.empty(40, 25, device=args.device)
                    camera = torch.load("./camera.pt")
                    rot = torch.tensor([[1, 0, 0, 0],
                        [0, -1, 0, 0],
                    ...
                    for i in range(triplane_gt_BL.shape[0]):
                        triplane_i = triplane_gt_BL[i].unsqueeze(0)
                        if args.flexicubes == False:
                            # render_video_given_triplane(triplane_i, trainer.vae_local, name_prefix=f'{os.path.basename(candidate_list[iter]).split(".")[0]}', render_reference={'c': camera}, save_img=True, save_mesh=True, save_path=os.path.join("/mnt/slurm_home/ywchen/projects/VAR-image/VAR/ten_scale",os.path.basename(candidate_list[iter]).split(".")[0], str(k)))
                            # shutil.copy(candidate_list[iter], os.path.join("/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/",os.path.basename(candidate_list[iter]).split(".")[0]))
                            render_video_given_triplane(triplane_i, trainer.vae_local, name_prefix=f'{file_name}', render_reference={'c': camera}, save_img=True, save_mesh=True, save_path=os.path.join("/mnt/slurm_home/ywchen/projects/VAR-image/VAR/ten_scale",file_name, str(k)))
                            # shutil.copy(candidate_list[iter], os.path.join("/mnt/slurm_home/ywchen/data/datasets/objv_chunk_v=6/bs_12_shuffle/170K/256/visualize/",file_name))
                            # st()
                        else:
                            render_video_given_triplane_mesh(triplane_i, trainer.vae_local, name_prefix=f'{os.path.basename(candidate_list[iter]).split(".")[0]}', render_reference={'c': camera}, save_img=False, save_mesh=True, save_path=args.save_path)
