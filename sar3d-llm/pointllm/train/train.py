...
from pointllm.data import make_object_point_data_module, make_object_point_data_module_objaverse
...
def train():
    ...
    #                                                 data_args=data_args)
    # st()
    data_module = make_object_point_data_module_objaverse(tokenizer=tokenizer,
                                                    data_args=data_args)
    # st()
