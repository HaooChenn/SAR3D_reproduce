...
from pointllm.model.ldm.modules.attention import CrossAttention
from pointllm.model.vit.vision_transformer import MemEffAttention as Attention
...
from pointllm.model.ldm.modules.attention import MemoryEfficientCrossAttention
...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        if timm.__version__ != '0.6.13':
            raise ValueError("Please use timm 0.6.13 for now")
