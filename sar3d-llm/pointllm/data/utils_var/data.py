...
from datasets.g_buffer_objaverse import ChunkObjaverseDataset
...
def build_dataset_3D_VAR(data_path: str, reso: int, reso_encoder: int, preprocess: bool, 
                         load_depth: bool, imgnet_normalize: bool, dataset_size: int
):
    
    train_set = ChunkObjaverseDataset(data_path,
                                    reso,
                                    reso_encoder,
                                    test=False,
    ...
    val_set = ChunkObjaverseDataset(data_path,
                                    reso,
                                    reso_encoder,
                                    test=False,
                                    preprocess=preprocess,
